            ...
            return (
              <StaggerItem key={m.name} className="h-full">
                ...
                >
                  ...
                  {m.recommended && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-primary text-white text-[10px] font-bold uppercase tracking-widest rounded-full shadow-lg">
                      Most Popular
                    </div>
                  )}

                  {/* Icon */}
                  <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${m.color} flex items-center justify-center mb-8 relative`}>
                  ...
                  <div className="flex-1 mb-8">
                    ...
                    <div className="w-10 h-1 bg-slate-100 mb-6 group-hover:w-20 transition-all duration-500" />
